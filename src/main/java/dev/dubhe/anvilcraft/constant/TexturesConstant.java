...
public class TexturesConstant {
    ...
    public static final ResourceLocation EMBER_GRINDSTONE_BUTTON = AnvilCraft.of(
        "textures/gui/container/smithing/ember_grindstone_button.png"
    );
    public static final ResourceLocation EMBER_GRINDSTONE_SLIDER = AnvilCraft.of(
        "textures/gui/container/smithing/ember_grindstone_slider.png"
    );
}
