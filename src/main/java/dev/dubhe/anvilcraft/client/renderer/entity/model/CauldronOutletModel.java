...
public class CauldronOutletModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = 
        new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("anvilcraft", "cauldron_outlet"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition outlet = partdefinition.addOrReplaceChild("outlet", CubeListBuilder.create()
                .texOffs(0, 8)
                .addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F),
            PartPose.ZERO);

        outlet.addOrReplaceChild("cube_inverted", CubeListBuilder.create()
                .texOffs(7, 8)
