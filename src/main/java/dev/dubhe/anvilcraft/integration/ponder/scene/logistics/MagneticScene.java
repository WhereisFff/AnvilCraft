...
public class MagneticScene {
    ...
    private static void basicOperation(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(40)
            ...
            .pointAt(util.vector().topOf(magneticPos))
            .attachKeyFrame()
            .placeNearTarget();
        scene.idle(50);
        ...
        ElementLink<EntityElement> chuteItems = scene.world().createItemEntity(chuteItemPos, Vec3.ZERO, ironIngot);
        scene.idle(8);
        // 模拟溜槽吸收物品
        ...
        ElementLink<EntityElement> magneticItems = scene.world().createItemEntity(magneticItemPos, Vec3.ZERO, goldIngot);
        scene.idle(8);
        // 模拟磁性溜槽吸收物品
